...
$old_error_handler = set_error_handler("form_activos_scriptcase_error_handler");

function form_activos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_activos']['contr_erro']) && $_SESSION['scriptcase']['form_activos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_activos->contr_form_activos->Apl_com_erro = true;
            if ($inicial_form_activos->contr_form_activos->NM_ajax_flag)
            {
                $inicial_form_activos->contr_form_activos->NM_ajax_info['errList']['geral_form_activos'][] = $msg;
                return;
            }
            form_activos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_activos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_activos'])  && '' != $_SESSION['scriptcase']['error_icon']['form_activos'])  ? $_SESSION['scriptcase']['error_icon']['form_activos']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_activos']) && '' != $_SESSION['scriptcase']['error_span_title']['form_activos']) ? $_SESSION['scriptcase']['error_span_title']['form_activos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_activos']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_activos']) ? $_SESSION['scriptcase']['error_icon_title']['form_activos'] : '';
?>
