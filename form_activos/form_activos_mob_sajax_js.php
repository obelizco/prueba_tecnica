  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_activos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_activos_mob_form();
	}

  // ---------- Validate id_actvo
  function do_ajax_form_activos_mob_validate_id_actvo()
  {
    var nomeCampo_id_actvo = "id_actvo";
    var var_id_actvo = scAjaxGetFieldHidden(nomeCampo_id_actvo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_actvo(var_id_actvo, var_script_case_init, do_ajax_form_activos_mob_validate_id_actvo_cb);
  } // do_ajax_form_activos_mob_validate_id_actvo

  function do_ajax_form_activos_mob_validate_id_actvo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_actvo_cb

  // ---------- Validate nmbre
  function do_ajax_form_activos_mob_validate_nmbre()
  {
    var nomeCampo_nmbre = "nmbre";
    var var_nmbre = scAjaxGetFieldText(nomeCampo_nmbre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_nmbre(var_nmbre, var_script_case_init, do_ajax_form_activos_mob_validate_nmbre_cb);
  } // do_ajax_form_activos_mob_validate_nmbre

  function do_ajax_form_activos_mob_validate_nmbre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nmbre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_nmbre_cb

  // ---------- Validate cdgo
  function do_ajax_form_activos_mob_validate_cdgo()
  {
    var nomeCampo_cdgo = "cdgo";
    var var_cdgo = scAjaxGetFieldText(nomeCampo_cdgo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_cdgo(var_cdgo, var_script_case_init, do_ajax_form_activos_mob_validate_cdgo_cb);
  } // do_ajax_form_activos_mob_validate_cdgo

  function do_ajax_form_activos_mob_validate_cdgo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cdgo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_cdgo_cb

  // ---------- Validate rfrncia
  function do_ajax_form_activos_mob_validate_rfrncia()
  {
    var nomeCampo_rfrncia = "rfrncia";
    var var_rfrncia = scAjaxGetFieldText(nomeCampo_rfrncia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_rfrncia(var_rfrncia, var_script_case_init, do_ajax_form_activos_mob_validate_rfrncia_cb);
  } // do_ajax_form_activos_mob_validate_rfrncia

  function do_ajax_form_activos_mob_validate_rfrncia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rfrncia";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_rfrncia_cb

  // ---------- Validate srial
  function do_ajax_form_activos_mob_validate_srial()
  {
    var nomeCampo_srial = "srial";
    var var_srial = scAjaxGetFieldText(nomeCampo_srial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_srial(var_srial, var_script_case_init, do_ajax_form_activos_mob_validate_srial_cb);
  } // do_ajax_form_activos_mob_validate_srial

  function do_ajax_form_activos_mob_validate_srial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "srial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_srial_cb

  // ---------- Validate nmro_actvo
  function do_ajax_form_activos_mob_validate_nmro_actvo()
  {
    var nomeCampo_nmro_actvo = "nmro_actvo";
    var var_nmro_actvo = scAjaxGetFieldText(nomeCampo_nmro_actvo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_nmro_actvo(var_nmro_actvo, var_script_case_init, do_ajax_form_activos_mob_validate_nmro_actvo_cb);
  } // do_ajax_form_activos_mob_validate_nmro_actvo

  function do_ajax_form_activos_mob_validate_nmro_actvo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_nmro_actvo_cb

  // ---------- Validate alias
  function do_ajax_form_activos_mob_validate_alias()
  {
    var nomeCampo_alias = "alias";
    var var_alias = scAjaxGetFieldText(nomeCampo_alias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_alias(var_alias, var_script_case_init, do_ajax_form_activos_mob_validate_alias_cb);
  } // do_ajax_form_activos_mob_validate_alias

  function do_ajax_form_activos_mob_validate_alias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alias";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_alias_cb

  // ---------- Validate cdgo_qr
  function do_ajax_form_activos_mob_validate_cdgo_qr()
  {
    var nomeCampo_cdgo_qr = "cdgo_qr";
    var var_cdgo_qr = scAjaxGetFieldText(nomeCampo_cdgo_qr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_cdgo_qr(var_cdgo_qr, var_script_case_init, do_ajax_form_activos_mob_validate_cdgo_qr_cb);
  } // do_ajax_form_activos_mob_validate_cdgo_qr

  function do_ajax_form_activos_mob_validate_cdgo_qr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cdgo_qr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_cdgo_qr_cb

  // ---------- Validate cdgo_brras
  function do_ajax_form_activos_mob_validate_cdgo_brras()
  {
    var nomeCampo_cdgo_brras = "cdgo_brras";
    var var_cdgo_brras = scAjaxGetFieldText(nomeCampo_cdgo_brras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_cdgo_brras(var_cdgo_brras, var_script_case_init, do_ajax_form_activos_mob_validate_cdgo_brras_cb);
  } // do_ajax_form_activos_mob_validate_cdgo_brras

  function do_ajax_form_activos_mob_validate_cdgo_brras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_cdgo_brras_cb

  // ---------- Validate cdgo_rfid
  function do_ajax_form_activos_mob_validate_cdgo_rfid()
  {
    var nomeCampo_cdgo_rfid = "cdgo_rfid";
    var var_cdgo_rfid = scAjaxGetFieldText(nomeCampo_cdgo_rfid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_cdgo_rfid(var_cdgo_rfid, var_script_case_init, do_ajax_form_activos_mob_validate_cdgo_rfid_cb);
  } // do_ajax_form_activos_mob_validate_cdgo_rfid

  function do_ajax_form_activos_mob_validate_cdgo_rfid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_cdgo_rfid_cb

  // ---------- Validate cmpsto
  function do_ajax_form_activos_mob_validate_cmpsto()
  {
    var nomeCampo_cmpsto = "cmpsto";
    var var_cmpsto = scAjaxGetFieldSelect(nomeCampo_cmpsto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_cmpsto(var_cmpsto, var_script_case_init, do_ajax_form_activos_mob_validate_cmpsto_cb);
  } // do_ajax_form_activos_mob_validate_cmpsto

  function do_ajax_form_activos_mob_validate_cmpsto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cmpsto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_cmpsto_cb

  // ---------- Validate id_estdo
  function do_ajax_form_activos_mob_validate_id_estdo()
  {
    var nomeCampo_id_estdo = "id_estdo";
    var var_id_estdo = scAjaxGetFieldSelect(nomeCampo_id_estdo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_estdo(var_id_estdo, var_script_case_init, do_ajax_form_activos_mob_validate_id_estdo_cb);
  } // do_ajax_form_activos_mob_validate_id_estdo

  function do_ajax_form_activos_mob_validate_id_estdo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_estdo_cb

  // ---------- Validate id_clse
  function do_ajax_form_activos_mob_validate_id_clse()
  {
    var nomeCampo_id_clse = "id_clse";
    var var_id_clse = scAjaxGetFieldSelect(nomeCampo_id_clse);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_clse(var_id_clse, var_script_case_init, do_ajax_form_activos_mob_validate_id_clse_cb);
  } // do_ajax_form_activos_mob_validate_id_clse

  function do_ajax_form_activos_mob_validate_id_clse_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_clse";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_clse_cb

  // ---------- Validate id_tpo
  function do_ajax_form_activos_mob_validate_id_tpo()
  {
    var nomeCampo_id_tpo = "id_tpo";
    var var_id_tpo = scAjaxGetFieldSelect(nomeCampo_id_tpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_tpo(var_id_tpo, var_script_case_init, do_ajax_form_activos_mob_validate_id_tpo_cb);
  } // do_ajax_form_activos_mob_validate_id_tpo

  function do_ajax_form_activos_mob_validate_id_tpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_tpo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_tpo_cb

  // ---------- Validate id_mrca
  function do_ajax_form_activos_mob_validate_id_mrca()
  {
    var nomeCampo_id_mrca = "id_mrca";
    var var_id_mrca = scAjaxGetFieldSelect(nomeCampo_id_mrca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_mrca(var_id_mrca, var_script_case_init, do_ajax_form_activos_mob_validate_id_mrca_cb);
  } // do_ajax_form_activos_mob_validate_id_mrca

  function do_ajax_form_activos_mob_validate_id_mrca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_mrca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_mrca_cb

  // ---------- Validate mdlo
  function do_ajax_form_activos_mob_validate_mdlo()
  {
    var nomeCampo_mdlo = "mdlo";
    var var_mdlo = scAjaxGetFieldText(nomeCampo_mdlo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_mdlo(var_mdlo, var_script_case_init, do_ajax_form_activos_mob_validate_mdlo_cb);
  } // do_ajax_form_activos_mob_validate_mdlo

  function do_ajax_form_activos_mob_validate_mdlo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mdlo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_mdlo_cb

  // ---------- Validate id_fbrcnte
  function do_ajax_form_activos_mob_validate_id_fbrcnte()
  {
    var nomeCampo_id_fbrcnte = "id_fbrcnte";
    var var_id_fbrcnte = scAjaxGetFieldSelect(nomeCampo_id_fbrcnte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_fbrcnte(var_id_fbrcnte, var_script_case_init, do_ajax_form_activos_mob_validate_id_fbrcnte_cb);
  } // do_ajax_form_activos_mob_validate_id_fbrcnte

  function do_ajax_form_activos_mob_validate_id_fbrcnte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_fbrcnte_cb

  // ---------- Validate cnfbldad
  function do_ajax_form_activos_mob_validate_cnfbldad()
  {
    var nomeCampo_cnfbldad = "cnfbldad";
    var var_cnfbldad = scAjaxGetFieldText(nomeCampo_cnfbldad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_cnfbldad(var_cnfbldad, var_script_case_init, do_ajax_form_activos_mob_validate_cnfbldad_cb);
  } // do_ajax_form_activos_mob_validate_cnfbldad

  function do_ajax_form_activos_mob_validate_cnfbldad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_cnfbldad_cb

  // ---------- Validate id_nit_prvdor
  function do_ajax_form_activos_mob_validate_id_nit_prvdor()
  {
    var nomeCampo_id_nit_prvdor = "id_nit_prvdor";
    var var_id_nit_prvdor = scAjaxGetFieldSelect(nomeCampo_id_nit_prvdor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_nit_prvdor(var_id_nit_prvdor, var_script_case_init, do_ajax_form_activos_mob_validate_id_nit_prvdor_cb);
  } // do_ajax_form_activos_mob_validate_id_nit_prvdor

  function do_ajax_form_activos_mob_validate_id_nit_prvdor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_nit_prvdor_cb

  // ---------- Validate fcha_cmpra
  function do_ajax_form_activos_mob_validate_fcha_cmpra()
  {
    var nomeCampo_fcha_cmpra = "fcha_cmpra";
    var var_fcha_cmpra = scAjaxGetFieldText(nomeCampo_fcha_cmpra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fcha_cmpra(var_fcha_cmpra, var_script_case_init, do_ajax_form_activos_mob_validate_fcha_cmpra_cb);
  } // do_ajax_form_activos_mob_validate_fcha_cmpra

  function do_ajax_form_activos_mob_validate_fcha_cmpra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fcha_cmpra_cb

  // ---------- Validate fcha_arrnque
  function do_ajax_form_activos_mob_validate_fcha_arrnque()
  {
    var nomeCampo_fcha_arrnque = "fcha_arrnque";
    var var_fcha_arrnque = scAjaxGetFieldText(nomeCampo_fcha_arrnque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fcha_arrnque(var_fcha_arrnque, var_script_case_init, do_ajax_form_activos_mob_validate_fcha_arrnque_cb);
  } // do_ajax_form_activos_mob_validate_fcha_arrnque

  function do_ajax_form_activos_mob_validate_fcha_arrnque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fcha_arrnque_cb

  // ---------- Validate fcha_fin_grntia
  function do_ajax_form_activos_mob_validate_fcha_fin_grntia()
  {
    var nomeCampo_fcha_fin_grntia = "fcha_fin_grntia";
    var var_fcha_fin_grntia = scAjaxGetFieldText(nomeCampo_fcha_fin_grntia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fcha_fin_grntia(var_fcha_fin_grntia, var_script_case_init, do_ajax_form_activos_mob_validate_fcha_fin_grntia_cb);
  } // do_ajax_form_activos_mob_validate_fcha_fin_grntia

  function do_ajax_form_activos_mob_validate_fcha_fin_grntia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fcha_fin_grntia_cb

  // ---------- Validate vlor_cmpra1
  function do_ajax_form_activos_mob_validate_vlor_cmpra1()
  {
    var nomeCampo_vlor_cmpra1 = "vlor_cmpra1";
    var var_vlor_cmpra1 = scAjaxGetFieldText(nomeCampo_vlor_cmpra1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_vlor_cmpra1(var_vlor_cmpra1, var_script_case_init, do_ajax_form_activos_mob_validate_vlor_cmpra1_cb);
  } // do_ajax_form_activos_mob_validate_vlor_cmpra1

  function do_ajax_form_activos_mob_validate_vlor_cmpra1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_vlor_cmpra1_cb

  // ---------- Validate id_mnda_cmpra1
  function do_ajax_form_activos_mob_validate_id_mnda_cmpra1()
  {
    var nomeCampo_id_mnda_cmpra1 = "id_mnda_cmpra1";
    var var_id_mnda_cmpra1 = scAjaxGetFieldSelect(nomeCampo_id_mnda_cmpra1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_mnda_cmpra1(var_id_mnda_cmpra1, var_script_case_init, do_ajax_form_activos_mob_validate_id_mnda_cmpra1_cb);
  } // do_ajax_form_activos_mob_validate_id_mnda_cmpra1

  function do_ajax_form_activos_mob_validate_id_mnda_cmpra1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_mnda_cmpra1_cb

  // ---------- Validate vlor_cmpra2
  function do_ajax_form_activos_mob_validate_vlor_cmpra2()
  {
    var nomeCampo_vlor_cmpra2 = "vlor_cmpra2";
    var var_vlor_cmpra2 = scAjaxGetFieldText(nomeCampo_vlor_cmpra2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_vlor_cmpra2(var_vlor_cmpra2, var_script_case_init, do_ajax_form_activos_mob_validate_vlor_cmpra2_cb);
  } // do_ajax_form_activos_mob_validate_vlor_cmpra2

  function do_ajax_form_activos_mob_validate_vlor_cmpra2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_vlor_cmpra2_cb

  // ---------- Validate id_mnda_cmpra2
  function do_ajax_form_activos_mob_validate_id_mnda_cmpra2()
  {
    var nomeCampo_id_mnda_cmpra2 = "id_mnda_cmpra2";
    var var_id_mnda_cmpra2 = scAjaxGetFieldSelect(nomeCampo_id_mnda_cmpra2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_mnda_cmpra2(var_id_mnda_cmpra2, var_script_case_init, do_ajax_form_activos_mob_validate_id_mnda_cmpra2_cb);
  } // do_ajax_form_activos_mob_validate_id_mnda_cmpra2

  function do_ajax_form_activos_mob_validate_id_mnda_cmpra2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_mnda_cmpra2_cb

  // ---------- Validate id_area
  function do_ajax_form_activos_mob_validate_id_area()
  {
    var nomeCampo_id_area = "id_area";
    var var_id_area = scAjaxGetFieldSelect(nomeCampo_id_area);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_area(var_id_area, var_script_case_init, do_ajax_form_activos_mob_validate_id_area_cb);
  } // do_ajax_form_activos_mob_validate_id_area

  function do_ajax_form_activos_mob_validate_id_area_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_area";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_area_cb

  // ---------- Validate id_cntro_csto
  function do_ajax_form_activos_mob_validate_id_cntro_csto()
  {
    var nomeCampo_id_cntro_csto = "id_cntro_csto";
    var var_id_cntro_csto = scAjaxGetFieldText(nomeCampo_id_cntro_csto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_cntro_csto(var_id_cntro_csto, var_script_case_init, do_ajax_form_activos_mob_validate_id_cntro_csto_cb);
  } // do_ajax_form_activos_mob_validate_id_cntro_csto

  function do_ajax_form_activos_mob_validate_id_cntro_csto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_cntro_csto_cb

  // ---------- Validate id_ubccion
  function do_ajax_form_activos_mob_validate_id_ubccion()
  {
    var nomeCampo_id_ubccion = "id_ubccion";
    var var_id_ubccion = scAjaxGetFieldSelect(nomeCampo_id_ubccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_ubccion(var_id_ubccion, var_script_case_init, do_ajax_form_activos_mob_validate_id_ubccion_cb);
  } // do_ajax_form_activos_mob_validate_id_ubccion

  function do_ajax_form_activos_mob_validate_id_ubccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_ubccion_cb

  // ---------- Validate id_nit_rspnsble
  function do_ajax_form_activos_mob_validate_id_nit_rspnsble()
  {
    var nomeCampo_id_nit_rspnsble = "id_nit_rspnsble";
    var var_id_nit_rspnsble = scAjaxGetFieldSelect(nomeCampo_id_nit_rspnsble);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_nit_rspnsble(var_id_nit_rspnsble, var_script_case_init, do_ajax_form_activos_mob_validate_id_nit_rspnsble_cb);
  } // do_ajax_form_activos_mob_validate_id_nit_rspnsble

  function do_ajax_form_activos_mob_validate_id_nit_rspnsble_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_nit_rspnsble_cb

  // ---------- Validate id_cntdor
  function do_ajax_form_activos_mob_validate_id_cntdor()
  {
    var nomeCampo_id_cntdor = "id_cntdor";
    var var_id_cntdor = scAjaxGetFieldSelect(nomeCampo_id_cntdor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_cntdor(var_id_cntdor, var_script_case_init, do_ajax_form_activos_mob_validate_id_cntdor_cb);
  } // do_ajax_form_activos_mob_validate_id_cntdor

  function do_ajax_form_activos_mob_validate_id_cntdor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_cntdor_cb

  // ---------- Validate vlor_actual
  function do_ajax_form_activos_mob_validate_vlor_actual()
  {
    var nomeCampo_vlor_actual = "vlor_actual";
    var var_vlor_actual = scAjaxGetFieldText(nomeCampo_vlor_actual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_vlor_actual(var_vlor_actual, var_script_case_init, do_ajax_form_activos_mob_validate_vlor_actual_cb);
  } // do_ajax_form_activos_mob_validate_vlor_actual

  function do_ajax_form_activos_mob_validate_vlor_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_vlor_actual_cb

  // ---------- Validate fcha_lctra
  function do_ajax_form_activos_mob_validate_fcha_lctra()
  {
    var nomeCampo_fcha_lctra = "fcha_lctra";
    var var_fcha_lctra = scAjaxGetFieldText(nomeCampo_fcha_lctra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fcha_lctra(var_fcha_lctra, var_script_case_init, do_ajax_form_activos_mob_validate_fcha_lctra_cb);
  } // do_ajax_form_activos_mob_validate_fcha_lctra

  function do_ajax_form_activos_mob_validate_fcha_lctra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fcha_lctra_cb

  // ---------- Validate vlor_estndar
  function do_ajax_form_activos_mob_validate_vlor_estndar()
  {
    var nomeCampo_vlor_estndar = "vlor_estndar";
    var var_vlor_estndar = scAjaxGetFieldText(nomeCampo_vlor_estndar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_vlor_estndar(var_vlor_estndar, var_script_case_init, do_ajax_form_activos_mob_validate_vlor_estndar_cb);
  } // do_ajax_form_activos_mob_validate_vlor_estndar

  function do_ajax_form_activos_mob_validate_vlor_estndar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_vlor_estndar_cb

  // ---------- Validate id_tpo_mdcion
  function do_ajax_form_activos_mob_validate_id_tpo_mdcion()
  {
    var nomeCampo_id_tpo_mdcion = "id_tpo_mdcion";
    var var_id_tpo_mdcion = scAjaxGetFieldSelect(nomeCampo_id_tpo_mdcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_tpo_mdcion(var_id_tpo_mdcion, var_script_case_init, do_ajax_form_activos_mob_validate_id_tpo_mdcion_cb);
  } // do_ajax_form_activos_mob_validate_id_tpo_mdcion

  function do_ajax_form_activos_mob_validate_id_tpo_mdcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_tpo_mdcion_cb

  // ---------- Validate fto1
  function do_ajax_form_activos_mob_validate_fto1()
  {
    var nomeCampo_fto1 = "fto1";
    var var_fto1 = scAjaxGetFieldText(nomeCampo_fto1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fto1(var_fto1, var_script_case_init, do_ajax_form_activos_mob_validate_fto1_cb);
  } // do_ajax_form_activos_mob_validate_fto1

  function do_ajax_form_activos_mob_validate_fto1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fto1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fto1_cb

  // ---------- Validate fto2
  function do_ajax_form_activos_mob_validate_fto2()
  {
    var nomeCampo_fto2 = "fto2";
    var var_fto2 = scAjaxGetFieldText(nomeCampo_fto2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fto2(var_fto2, var_script_case_init, do_ajax_form_activos_mob_validate_fto2_cb);
  } // do_ajax_form_activos_mob_validate_fto2

  function do_ajax_form_activos_mob_validate_fto2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fto2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fto2_cb

  // ---------- Validate fto3
  function do_ajax_form_activos_mob_validate_fto3()
  {
    var nomeCampo_fto3 = "fto3";
    var var_fto3 = scAjaxGetFieldText(nomeCampo_fto3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fto3(var_fto3, var_script_case_init, do_ajax_form_activos_mob_validate_fto3_cb);
  } // do_ajax_form_activos_mob_validate_fto3

  function do_ajax_form_activos_mob_validate_fto3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fto3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fto3_cb

  // ---------- Validate fto4
  function do_ajax_form_activos_mob_validate_fto4()
  {
    var nomeCampo_fto4 = "fto4";
    var var_fto4 = scAjaxGetFieldText(nomeCampo_fto4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fto4(var_fto4, var_script_case_init, do_ajax_form_activos_mob_validate_fto4_cb);
  } // do_ajax_form_activos_mob_validate_fto4

  function do_ajax_form_activos_mob_validate_fto4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fto4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fto4_cb

  // ---------- Validate fto5
  function do_ajax_form_activos_mob_validate_fto5()
  {
    var nomeCampo_fto5 = "fto5";
    var var_fto5 = scAjaxGetFieldText(nomeCampo_fto5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fto5(var_fto5, var_script_case_init, do_ajax_form_activos_mob_validate_fto5_cb);
  } // do_ajax_form_activos_mob_validate_fto5

  function do_ajax_form_activos_mob_validate_fto5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fto5";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fto5_cb

  // ---------- Validate fto6
  function do_ajax_form_activos_mob_validate_fto6()
  {
    var nomeCampo_fto6 = "fto6";
    var var_fto6 = scAjaxGetFieldText(nomeCampo_fto6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fto6(var_fto6, var_script_case_init, do_ajax_form_activos_mob_validate_fto6_cb);
  } // do_ajax_form_activos_mob_validate_fto6

  function do_ajax_form_activos_mob_validate_fto6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fto6";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fto6_cb

  // ---------- Validate prmtro_oprcion
  function do_ajax_form_activos_mob_validate_prmtro_oprcion()
  {
    var nomeCampo_prmtro_oprcion = "prmtro_oprcion";
    var var_prmtro_oprcion = scAjaxGetFieldText(nomeCampo_prmtro_oprcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_prmtro_oprcion(var_prmtro_oprcion, var_script_case_init, do_ajax_form_activos_mob_validate_prmtro_oprcion_cb);
  } // do_ajax_form_activos_mob_validate_prmtro_oprcion

  function do_ajax_form_activos_mob_validate_prmtro_oprcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_prmtro_oprcion_cb

  // ---------- Validate nmbre_archvo_po
  function do_ajax_form_activos_mob_validate_nmbre_archvo_po()
  {
    var nomeCampo_nmbre_archvo_po = "nmbre_archvo_po";
    var var_nmbre_archvo_po = scAjaxGetFieldText(nomeCampo_nmbre_archvo_po);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_nmbre_archvo_po(var_nmbre_archvo_po, var_script_case_init, do_ajax_form_activos_mob_validate_nmbre_archvo_po_cb);
  } // do_ajax_form_activos_mob_validate_nmbre_archvo_po

  function do_ajax_form_activos_mob_validate_nmbre_archvo_po_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_nmbre_archvo_po_cb

  // ---------- Validate tmno_po
  function do_ajax_form_activos_mob_validate_tmno_po()
  {
    var nomeCampo_tmno_po = "tmno_po";
    var var_tmno_po = scAjaxGetFieldText(nomeCampo_tmno_po);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_tmno_po(var_tmno_po, var_script_case_init, do_ajax_form_activos_mob_validate_tmno_po_cb);
  } // do_ajax_form_activos_mob_validate_tmno_po

  function do_ajax_form_activos_mob_validate_tmno_po_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tmno_po";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_tmno_po_cb

  // ---------- Validate fcha_rgstro
  function do_ajax_form_activos_mob_validate_fcha_rgstro()
  {
    var nomeCampo_fcha_rgstro = "fcha_rgstro";
    var var_fcha_rgstro = scAjaxGetFieldText(nomeCampo_fcha_rgstro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fcha_rgstro(var_fcha_rgstro, var_script_case_init, do_ajax_form_activos_mob_validate_fcha_rgstro_cb);
  } // do_ajax_form_activos_mob_validate_fcha_rgstro

  function do_ajax_form_activos_mob_validate_fcha_rgstro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fcha_rgstro_cb

  // ---------- Validate id_usrio
  function do_ajax_form_activos_mob_validate_id_usrio()
  {
    var nomeCampo_id_usrio = "id_usrio";
    var var_id_usrio = scAjaxGetFieldSelect(nomeCampo_id_usrio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_usrio(var_id_usrio, var_script_case_init, do_ajax_form_activos_mob_validate_id_usrio_cb);
  } // do_ajax_form_activos_mob_validate_id_usrio

  function do_ajax_form_activos_mob_validate_id_usrio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_usrio_cb

  // ---------- Validate fcha_actlzcion
  function do_ajax_form_activos_mob_validate_fcha_actlzcion()
  {
    var nomeCampo_fcha_actlzcion = "fcha_actlzcion";
    var var_fcha_actlzcion = scAjaxGetFieldText(nomeCampo_fcha_actlzcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_fcha_actlzcion(var_fcha_actlzcion, var_script_case_init, do_ajax_form_activos_mob_validate_fcha_actlzcion_cb);
  } // do_ajax_form_activos_mob_validate_fcha_actlzcion

  function do_ajax_form_activos_mob_validate_fcha_actlzcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_fcha_actlzcion_cb

  // ---------- Validate id_usrio_actlzcion
  function do_ajax_form_activos_mob_validate_id_usrio_actlzcion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_activos_mob_validate_id_usrio_actlzcion(var_id_usrio_actlzcion, var_script_case_init, do_ajax_form_activos_mob_validate_id_usrio_actlzcion_cb);
  } // do_ajax_form_activos_mob_validate_id_usrio_actlzcion

  function do_ajax_form_activos_mob_validate_id_usrio_actlzcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_activos_mob_validate_id_usrio_actlzcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_activos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_activos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_activos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_activos_mob_submit_form_cb
  function do_ajax_form_activos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_activos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_activos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_activos_mob_navigate_form(var_id_actvo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_activos_mob_navigate_form_cb);
  } // do_ajax_form_activos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_activos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_activos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_activos_mob_navigate_form_cb
  function do_ajax_form_activos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_activos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_activos_mob_navigate_form_cb_after_alert
  function sc_hide_form_activos_mob_form()
  {
