...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_activos_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_activos_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_activos']['error_buffer']) && '' != $_SESSION['scriptcase']['form_activos']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_activos']['error_buffer'];
}
...
<?php
 include_once("form_activos_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" enctype="multipart/form-data" 
               action="form_activos_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_activos_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_activos_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_id_actvo_line" id="hidden_field_data_id_actvo" style="<?php echo $sStyleHidden_id_actvo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_actvo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_actvo_label"><span id="id_label_id_actvo"><?php echo $this->nm_new_label['id_actvo']; ?></span></span><br><span id="id_read_on_id_actvo" class="css_id_actvo_line" style="<?php echo $sStyleReadLab_id_actvo; ?>"><?php echo $this->form_encode_input($this->id_actvo); ?></span><span id="id_read_off_id_actvo" class="css_read_off_id_actvo" style="<?php echo $sStyleReadInp_id_actvo; ?>"><input type="hidden" name="id_actvo" value="<?php echo $this->form_encode_input($id_actvo) . "\">"?><span id="id_ajax_label_id_actvo"><?php echo nl2br($id_actvo); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nmbre_line" id="hidden_field_data_nmbre" style="<?php echo $sStyleHidden_nmbre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nmbre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nmbre_label"><span id="id_label_nmbre"><?php echo $this->nm_new_label['nmbre']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cdgo_line" id="hidden_field_data_cdgo" style="<?php echo $sStyleHidden_cdgo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cdgo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cdgo_label"><span id="id_label_cdgo"><?php echo $this->nm_new_label['cdgo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rfrncia_line" id="hidden_field_data_rfrncia" style="<?php echo $sStyleHidden_rfrncia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rfrncia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rfrncia_label"><span id="id_label_rfrncia"><?php echo $this->nm_new_label['rfrncia']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_srial_line" id="hidden_field_data_srial" style="<?php echo $sStyleHidden_srial; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_srial_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_srial_label"><span id="id_label_srial"><?php echo $this->nm_new_label['srial']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nmro_actvo_line" id="hidden_field_data_nmro_actvo" style="<?php echo $sStyleHidden_nmro_actvo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nmro_actvo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nmro_actvo_label"><span id="id_label_nmro_actvo"><?php echo $this->nm_new_label['nmro_actvo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_alias_line" id="hidden_field_data_alias" style="<?php echo $sStyleHidden_alias; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_alias_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_alias_label"><span id="id_label_alias"><?php echo $this->nm_new_label['alias']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cdgo_qr_line" id="hidden_field_data_cdgo_qr" style="<?php echo $sStyleHidden_cdgo_qr; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cdgo_qr_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cdgo_qr_label"><span id="id_label_cdgo_qr"><?php echo $this->nm_new_label['cdgo_qr']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cdgo_brras_line" id="hidden_field_data_cdgo_brras" style="<?php echo $sStyleHidden_cdgo_brras; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cdgo_brras_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cdgo_brras_label"><span id="id_label_cdgo_brras"><?php echo $this->nm_new_label['cdgo_brras']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cdgo_rfid_line" id="hidden_field_data_cdgo_rfid" style="<?php echo $sStyleHidden_cdgo_rfid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cdgo_rfid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cdgo_rfid_label"><span id="id_label_cdgo_rfid"><?php echo $this->nm_new_label['cdgo_rfid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cmpsto_line" id="hidden_field_data_cmpsto" style="<?php echo $sStyleHidden_cmpsto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cmpsto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cmpsto_label"><span id="id_label_cmpsto"><?php echo $this->nm_new_label['cmpsto']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_estdo_line" id="hidden_field_data_id_estdo" style="<?php echo $sStyleHidden_id_estdo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_estdo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_estdo_label"><span id="id_label_id_estdo"><?php echo $this->nm_new_label['id_estdo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_clse_line" id="hidden_field_data_id_clse" style="<?php echo $sStyleHidden_id_clse; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_clse_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_clse_label"><span id="id_label_id_clse"><?php echo $this->nm_new_label['id_clse']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_tpo_line" id="hidden_field_data_id_tpo" style="<?php echo $sStyleHidden_id_tpo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tpo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_tpo_label"><span id="id_label_id_tpo"><?php echo $this->nm_new_label['id_tpo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_mrca_line" id="hidden_field_data_id_mrca" style="<?php echo $sStyleHidden_id_mrca; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_mrca_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_mrca_label"><span id="id_label_id_mrca"><?php echo $this->nm_new_label['id_mrca']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mdlo_line" id="hidden_field_data_mdlo" style="<?php echo $sStyleHidden_mdlo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mdlo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_mdlo_label"><span id="id_label_mdlo"><?php echo $this->nm_new_label['mdlo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_fbrcnte_line" id="hidden_field_data_id_fbrcnte" style="<?php echo $sStyleHidden_id_fbrcnte; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_fbrcnte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_fbrcnte_label"><span id="id_label_id_fbrcnte"><?php echo $this->nm_new_label['id_fbrcnte']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cnfbldad_line" id="hidden_field_data_cnfbldad" style="<?php echo $sStyleHidden_cnfbldad; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cnfbldad_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cnfbldad_label"><span id="id_label_cnfbldad"><?php echo $this->nm_new_label['cnfbldad']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_nit_prvdor_line" id="hidden_field_data_id_nit_prvdor" style="<?php echo $sStyleHidden_id_nit_prvdor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_nit_prvdor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_nit_prvdor_label"><span id="id_label_id_nit_prvdor"><?php echo $this->nm_new_label['id_nit_prvdor']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fcha_cmpra_line" id="hidden_field_data_fcha_cmpra" style="<?php echo $sStyleHidden_fcha_cmpra; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fcha_cmpra_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fcha_cmpra_label"><span id="id_label_fcha_cmpra"><?php echo $this->nm_new_label['fcha_cmpra']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fcha_arrnque_line" id="hidden_field_data_fcha_arrnque" style="<?php echo $sStyleHidden_fcha_arrnque; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fcha_arrnque_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fcha_arrnque_label"><span id="id_label_fcha_arrnque"><?php echo $this->nm_new_label['fcha_arrnque']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fcha_fin_grntia_line" id="hidden_field_data_fcha_fin_grntia" style="<?php echo $sStyleHidden_fcha_fin_grntia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fcha_fin_grntia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fcha_fin_grntia_label"><span id="id_label_fcha_fin_grntia"><?php echo $this->nm_new_label['fcha_fin_grntia']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vlor_cmpra1_line" id="hidden_field_data_vlor_cmpra1" style="<?php echo $sStyleHidden_vlor_cmpra1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vlor_cmpra1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vlor_cmpra1_label"><span id="id_label_vlor_cmpra1"><?php echo $this->nm_new_label['vlor_cmpra1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_mnda_cmpra1_line" id="hidden_field_data_id_mnda_cmpra1" style="<?php echo $sStyleHidden_id_mnda_cmpra1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_mnda_cmpra1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_mnda_cmpra1_label"><span id="id_label_id_mnda_cmpra1"><?php echo $this->nm_new_label['id_mnda_cmpra1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vlor_cmpra2_line" id="hidden_field_data_vlor_cmpra2" style="<?php echo $sStyleHidden_vlor_cmpra2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vlor_cmpra2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vlor_cmpra2_label"><span id="id_label_vlor_cmpra2"><?php echo $this->nm_new_label['vlor_cmpra2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_mnda_cmpra2_line" id="hidden_field_data_id_mnda_cmpra2" style="<?php echo $sStyleHidden_id_mnda_cmpra2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_mnda_cmpra2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_mnda_cmpra2_label"><span id="id_label_id_mnda_cmpra2"><?php echo $this->nm_new_label['id_mnda_cmpra2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_cntro_csto_line" id="hidden_field_data_id_cntro_csto" style="<?php echo $sStyleHidden_id_cntro_csto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_cntro_csto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_cntro_csto_label"><span id="id_label_id_cntro_csto"><?php echo $this->nm_new_label['id_cntro_csto']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_ubccion_line" id="hidden_field_data_id_ubccion" style="<?php echo $sStyleHidden_id_ubccion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_ubccion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_ubccion_label"><span id="id_label_id_ubccion"><?php echo $this->nm_new_label['id_ubccion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_nit_rspnsble_line" id="hidden_field_data_id_nit_rspnsble" style="<?php echo $sStyleHidden_id_nit_rspnsble; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_nit_rspnsble_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_nit_rspnsble_label"><span id="id_label_id_nit_rspnsble"><?php echo $this->nm_new_label['id_nit_rspnsble']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_cntdor_line" id="hidden_field_data_id_cntdor" style="<?php echo $sStyleHidden_id_cntdor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_cntdor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_cntdor_label"><span id="id_label_id_cntdor"><?php echo $this->nm_new_label['id_cntdor']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vlor_actual_line" id="hidden_field_data_vlor_actual" style="<?php echo $sStyleHidden_vlor_actual; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vlor_actual_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vlor_actual_label"><span id="id_label_vlor_actual"><?php echo $this->nm_new_label['vlor_actual']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fcha_lctra_line" id="hidden_field_data_fcha_lctra" style="<?php echo $sStyleHidden_fcha_lctra; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fcha_lctra_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fcha_lctra_label"><span id="id_label_fcha_lctra"><?php echo $this->nm_new_label['fcha_lctra']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vlor_estndar_line" id="hidden_field_data_vlor_estndar" style="<?php echo $sStyleHidden_vlor_estndar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vlor_estndar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vlor_estndar_label"><span id="id_label_vlor_estndar"><?php echo $this->nm_new_label['vlor_estndar']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_tpo_mdcion_line" id="hidden_field_data_id_tpo_mdcion" style="<?php echo $sStyleHidden_id_tpo_mdcion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tpo_mdcion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_tpo_mdcion_label"><span id="id_label_id_tpo_mdcion"><?php echo $this->nm_new_label['id_tpo_mdcion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fto1_line" id="hidden_field_data_fto1" style="<?php echo $sStyleHidden_fto1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fto1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fto1_label"><span id="id_label_fto1"><?php echo $this->nm_new_label['fto1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fto2_line" id="hidden_field_data_fto2" style="<?php echo $sStyleHidden_fto2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fto2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fto2_label"><span id="id_label_fto2"><?php echo $this->nm_new_label['fto2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fto3_line" id="hidden_field_data_fto3" style="<?php echo $sStyleHidden_fto3; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fto3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fto3_label"><span id="id_label_fto3"><?php echo $this->nm_new_label['fto3']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fto4_line" id="hidden_field_data_fto4" style="<?php echo $sStyleHidden_fto4; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fto4_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fto4_label"><span id="id_label_fto4"><?php echo $this->nm_new_label['fto4']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fto5_line" id="hidden_field_data_fto5" style="<?php echo $sStyleHidden_fto5; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fto5_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fto5_label"><span id="id_label_fto5"><?php echo $this->nm_new_label['fto5']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fto6_line" id="hidden_field_data_fto6" style="<?php echo $sStyleHidden_fto6; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fto6_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fto6_label"><span id="id_label_fto6"><?php echo $this->nm_new_label['fto6']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_prmtro_oprcion_line" id="hidden_field_data_prmtro_oprcion" style="<?php echo $sStyleHidden_prmtro_oprcion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prmtro_oprcion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_prmtro_oprcion_label"><span id="id_label_prmtro_oprcion"><?php echo $this->nm_new_label['prmtro_oprcion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nmbre_archvo_po_line" id="hidden_field_data_nmbre_archvo_po" style="<?php echo $sStyleHidden_nmbre_archvo_po; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nmbre_archvo_po_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nmbre_archvo_po_label"><span id="id_label_nmbre_archvo_po"><?php echo $this->nm_new_label['nmbre_archvo_po']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tmno_po_line" id="hidden_field_data_tmno_po" style="<?php echo $sStyleHidden_tmno_po; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tmno_po_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tmno_po_label"><span id="id_label_tmno_po"><?php echo $this->nm_new_label['tmno_po']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fcha_rgstro_line" id="hidden_field_data_fcha_rgstro" style="<?php echo $sStyleHidden_fcha_rgstro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fcha_rgstro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fcha_rgstro_label"><span id="id_label_fcha_rgstro"><?php echo $this->nm_new_label['fcha_rgstro']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_usrio_line" id="hidden_field_data_id_usrio" style="<?php echo $sStyleHidden_id_usrio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_usrio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_usrio_label"><span id="id_label_id_usrio"><?php echo $this->nm_new_label['id_usrio']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fcha_actlzcion_line" id="hidden_field_data_fcha_actlzcion" style="<?php echo $sStyleHidden_fcha_actlzcion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fcha_actlzcion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fcha_actlzcion_label"><span id="id_label_fcha_actlzcion"><?php echo $this->nm_new_label['fcha_actlzcion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_usrio_actlzcion_line" id="hidden_field_data_id_usrio_actlzcion" style="<?php echo $sStyleHidden_id_usrio_actlzcion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_usrio_actlzcion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_usrio_actlzcion_label"><span id="id_label_id_usrio_actlzcion"><?php echo $this->nm_new_label['id_usrio_actlzcion']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_activos_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_activos_mob");
 parent.scAjaxDetailHeight("form_activos_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
