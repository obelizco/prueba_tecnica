...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fcha_actlzcion_hora' + iSeqRow).bind('blur', function() { sc_form_activos_fcha_actlzcion_hora_onblur(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_activos_fcha_actlzcion_hora_onfocus(this, iSeqRow) });
...
function sc_form_activos_fcha_actlzcion_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_activos_validate_fcha_actlzcion();
  scCssBlur(oThis);
}
...
function sc_form_activos_fcha_actlzcion_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_activos_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fcha_cmpra" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_activos_validate_fcha_cmpra(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fcha_arrnque" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_activos_validate_fcha_arrnque(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fcha_fin_grntia" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_activos_validate_fcha_fin_grntia(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fcha_lctra" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_activos_validate_fcha_lctra(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fcha_rgstro" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_activos_validate_fcha_rgstro(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fcha_actlzcion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_activos_validate_fcha_actlzcion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
