<?php  
  ...
  session_start() ;
  class form_activos_form_teste
  {
   function form_activos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_activos/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_activos</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_activos"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_activos_form_teste();
  $frm_teste->form_activos_teste();
?>
