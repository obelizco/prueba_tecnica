...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_activos']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_activos']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_activos']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_activos']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_activos']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_activos']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_activos']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_activos']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_activos']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_activos']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_activos']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_activos']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_activos']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_activos']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_activos']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_activos_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_activos']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_activos']['upload_field_info']['fto1'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_activos',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_activos']['upload_field_info']['fto2'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_activos',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_activos']['upload_field_info']['fto3'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_activos',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_activos']['upload_field_info']['fto4'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_activos',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_activos']['upload_field_info']['fto5'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_activos',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_activos']['upload_field_info']['fto6'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_activos',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_activos']['upload_field_info']['prmtro_oprcion'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_activos',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_activos']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_activos'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_activos']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_activos']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_activos') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_activos']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " activos";
      ...
      $_SESSION['scriptcase']['error_icon']['form_activos']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_activos'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto1_ul_name]))
          {
              $this->NM_ajax_info['param']['fto1_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto1_ul_name];
          }
      ...
      elseif (isset($this->fto1_ul_name) && '' != $this->fto1_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto1_ul_name]))
          {
              $this->fto1_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto1_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto2_ul_name]))
          {
              $this->NM_ajax_info['param']['fto2_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto2_ul_name];
          }
      ...
      elseif (isset($this->fto2_ul_name) && '' != $this->fto2_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto2_ul_name]))
          {
              $this->fto2_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto2_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto3_ul_name]))
          {
              $this->NM_ajax_info['param']['fto3_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto3_ul_name];
          }
      ...
      elseif (isset($this->fto3_ul_name) && '' != $this->fto3_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto3_ul_name]))
          {
              $this->fto3_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto3_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto4_ul_name]))
          {
              $this->NM_ajax_info['param']['fto4_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto4_ul_name];
          }
      ...
      elseif (isset($this->fto4_ul_name) && '' != $this->fto4_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto4_ul_name]))
          {
              $this->fto4_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto4_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto5_ul_name]))
          {
              $this->NM_ajax_info['param']['fto5_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto5_ul_name];
          }
      ...
      elseif (isset($this->fto5_ul_name) && '' != $this->fto5_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto5_ul_name]))
          {
              $this->fto5_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto5_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto6_ul_name]))
          {
              $this->NM_ajax_info['param']['fto6_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto6_ul_name];
          }
      ...
      elseif (isset($this->fto6_ul_name) && '' != $this->fto6_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto6_ul_name]))
          {
              $this->fto6_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->fto6_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->prmtro_oprcion_ul_name]))
          {
              $this->NM_ajax_info['param']['prmtro_oprcion_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->prmtro_oprcion_ul_name];
          }
      ...
      elseif (isset($this->prmtro_oprcion_ul_name) && '' != $this->prmtro_oprcion_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->prmtro_oprcion_ul_name]))
          {
              $this->prmtro_oprcion_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_field_ul_name'][$this->prmtro_oprcion_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_activos']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_activos']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_activos']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_activos']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_activos'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_activos'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_activos']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_activos']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_activos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_activos/form_activos_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_activos_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_activos_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_activos_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_activos/form_activos_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_activos_erro.class.php"); 
      }
      $this->Erro      = new form_activos_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opcao']))
         { 
             if ($this->id_actvo != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_activos']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_activos']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_activos.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_activos_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_activos"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_activos']) || !is_array($this->NM_ajax_info['errList']['geral_form_activos']))
              {
                  $this->NM_ajax_info['errList']['geral_form_activos'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_activos'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_cmpsto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cmpsto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_cmpsto']) && !in_array($this->cmpsto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_cmpsto']))
               {
                   $hasError = true;
    ...
    function ValidateField_id_estdo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_estdo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_estdo']) && !in_array($this->id_estdo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_estdo']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_clse(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_clse) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_clse']) && !in_array($this->id_clse, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_clse']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_tpo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_tpo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_tpo']) && !in_array($this->id_tpo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_tpo']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_mrca(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_mrca) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_mrca']) && !in_array($this->id_mrca, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_mrca']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_fbrcnte(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_fbrcnte) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_fbrcnte']) && !in_array($this->id_fbrcnte, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_fbrcnte']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cnfbldad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cnfbldad, 14, 6, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_id_nit_prvdor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_nit_prvdor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_nit_prvdor']) && !in_array($this->id_nit_prvdor, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_nit_prvdor']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_vlor_cmpra1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->vlor_cmpra1, 14, 6, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_id_mnda_cmpra1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_mnda_cmpra1) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_mnda_cmpra1']) && !in_array($this->id_mnda_cmpra1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_mnda_cmpra1']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_vlor_cmpra2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->vlor_cmpra2, 14, 6, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_id_mnda_cmpra2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_mnda_cmpra2) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_mnda_cmpra2']) && !in_array($this->id_mnda_cmpra2, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_mnda_cmpra2']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_area(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_area) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_area']) && !in_array($this->id_area, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_area']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_cntro_csto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->id_cntro_csto, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_id_ubccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_ubccion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_ubccion']) && !in_array($this->id_ubccion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_ubccion']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_nit_rspnsble(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_nit_rspnsble) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_nit_rspnsble']) && !in_array($this->id_nit_rspnsble, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_nit_rspnsble']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_cntdor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_cntdor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_cntdor']) && !in_array($this->id_cntdor, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_cntdor']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_vlor_actual(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->vlor_actual, 14, 6, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_vlor_estndar(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->vlor_estndar, 14, 6, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_id_tpo_mdcion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_tpo_mdcion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_tpo_mdcion']) && !in_array($this->id_tpo_mdcion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_tpo_mdcion']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_usrio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_usrio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_usrio']) && !in_array($this->id_usrio, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['Lookup_id_usrio']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_activos_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto1']) && $this->fto1_limpa != "S")
          {
              $this->fto1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto1'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto2']) && $this->fto2_limpa != "S")
          {
              $this->fto2 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto2'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto3']) && $this->fto3_limpa != "S")
          {
              $this->fto3 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto3'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto4']) && $this->fto4_limpa != "S")
          {
              $this->fto4 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto4'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto5']) && $this->fto5_limpa != "S")
          {
              $this->fto5 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto5'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto6']) && $this->fto6_limpa != "S")
          {
              $this->fto6 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['fto6'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['prmtro_oprcion']) && $this->prmtro_oprcion_limpa != "S")
          {
              $this->prmtro_oprcion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form']['prmtro_oprcion'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_actvo']['keyVal'] = form_activos_pack_protect_string($this->nmgp_dados_form['id_actvo']);
          }
   } // ajax_return_values
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_activos_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_activos_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cmpsto']['valList'][$i] = form_activos_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_estdo']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_clse']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_tpo']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_mrca']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_fbrcnte']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_nit_prvdor']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_mnda_cmpra1']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_mnda_cmpra2']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_area']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_ubccion']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_nit_rspnsble']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_cntdor']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_tpo_mdcion']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_usrio']['valList'][$i] = form_activos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_id_usrio_actlzcion($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_activos']['contr_erro'] = 'on';
             /* actvos_btcra */
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_activos' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_activos']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['parms'] = "id_actvo?#?$this->id_actvo?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_activos = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total'] = $qt_geral_reg_form_activos;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_actvo))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_activos = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] > $qt_geral_reg_form_activos)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] = $qt_geral_reg_form_activos; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_activos) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start']) ;  
              } 
          } 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['parms'] = "id_actvo?#?$this->id_actvo?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sub_dir'][0]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sub_dir'][1]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sub_dir'][2]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sub_dir'][3]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sub_dir'][4]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sub_dir'][5]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['sub_dir'][6]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] < $qt_geral_reg_form_activos;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out_prmtro_oprcion))
       {
        ...
        $this->initFormPages();
    include_once("form_activos_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_activos = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['total'] = $qt_geral_reg_form_activos;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_activos_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_activos_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_activos_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_activos']['masterValue']))
{
