<?php
@session_start() ;
$_SESSION['scriptcase']['grid_activos']['sc_process_barr'] = true;
require_once('../grid_activos/index.php');
unset($_SESSION['scriptcase']['grid_activos']['sc_process_barr']);
$ExportCtrl = new grid_activos_export_control;
$ExportCtrl->Export_barr();

class grid_activos_export_control
{
