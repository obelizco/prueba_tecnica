...
<?php
   ...
   $Ord_Cmp = new grid_activos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_activos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_actvo'] = "ID_ACTVO";
   $tab_labels["id_actvo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["id_actvo"])) ? $_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["id_actvo"] : "ID ACTVO";
   $tab_ger_campos['nmbre'] = "on";
   $tab_def_campos['nmbre'] = "NMBRE";
   $tab_labels["nmbre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["nmbre"])) ? $_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["nmbre"] : "NMBRE";
   $tab_ger_campos['cdgo'] = "on";
   $tab_def_campos['cdgo'] = "CDGO";
   $tab_labels["cdgo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["cdgo"])) ? $_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["cdgo"] : "CDGO";
   $tab_ger_campos['rfrncia'] = "on";
   $tab_def_campos['rfrncia'] = "RFRNCIA";
   $tab_labels["rfrncia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["rfrncia"])) ? $_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["rfrncia"] : "RFRNCIA";
   $tab_ger_campos['srial'] = "on";
   $tab_def_campos['srial'] = "SRIAL";
   $tab_labels["srial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["srial"])) ? $_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["srial"] : "SRIAL";
   $tab_ger_campos['nmro_actvo'] = "on";
   $tab_def_campos['nmro_actvo'] = "NMRO_ACTVO";
   $tab_labels["nmro_actvo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["nmro_actvo"])) ? $_SESSION['sc_session'][$sc_init]['grid_activos']['labels']["nmro_actvo"] : "NMRO ACTVO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_activos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_activos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_activos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_activos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_activos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
