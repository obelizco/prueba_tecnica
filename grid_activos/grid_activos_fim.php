...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba_____grid_activos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba_____grid_activos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_activos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_activos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_activos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_activos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_activos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_activos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_activos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_activos']['embutida_filho'] as $ind => $sc_init)
          {
